...
class Settings:
    def __init__(self, config_values):
        self.TELEGRAM_BOT_TOKEN: str = config_values.get("BOT_TOKEN", "")
        print(f"DEBUG: Loaded TELEGRAM_BOT_TOKEN: {self.TELEGRAM_BOT_TOKEN[:10]}...{self.TELEGRAM_BOT_TOKEN[-10:]}", flush=True)
